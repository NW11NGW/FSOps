...
namespace FSOps.Data.Migrations
{
    ...
    [Migration("20260820200819_AddContractCompletionBonus")]
    partial class AddContractCompletionBonus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FSOps.Core.Entities.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("AircraftTypeDesignator")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("CompletionBonus")
                        .HasPrecision(18, 2)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset>("OfferedUtc")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("TotalPlannedBlockMinutes")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("AirlineId", "BoardBucket", "BoardSlot")
                        .IsUnique();

                    b.ToTable("Contracts");
                });

            modelBuilder.Entity("FSOps.Core.Entities.ContractLeg", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("FlownUtc")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FSOps.Core.Entities.ReputationSnapshot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FSOps.Core.Entities.UserSettings", b =>
                {
                    ...
                    b.Property<string>("SimAircraftOverridesJson")
                        .HasColumnType("TEXT");

                    b.Property<string>("SimAircraftScanJson")
                        .HasColumnType("TEXT");

                    b.Property<string>("SimBriefPilotId")
                        .HasColumnType("TEXT");

                    b.Property<string>("SimEdition")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT")
            ...
            modelBuilder.Entity("FSOps.Core.Entities.ContractLeg", b =>
                {
                    b.HasOne("FSOps.Core.Entities.Contract", null)
                        .WithMany("Legs")
