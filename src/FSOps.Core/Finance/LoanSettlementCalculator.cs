...
/// <summary>
/// Pure early-settlement and overpayment arithmetic for a <see cref="Entities.Loan"/> - see
/// docs/PLAN.md "Paying a loan back, and seeing your money at all". Builds on
...
public static class LoanSettlementCalculator
{
    ...
    /// docs/PLAN.md "Show the payoff figure and the interest saved before confirming". The fee is
    ...
    /// is left - see docs/PLAN.md "state clearly which the overpayment does - shorten the term or
    /// reduce the monthly payment": this app shortens the term.
    /// </summary>
