 ...
 * turns it on; a missing key, a malformed value, or `localStorage` throwing (a locked-down embed
 * or a privacy-restricted browser) must all resolve to hidden, never to a quiet default-on.
 *
