...
/// <summary>
/// Acceptance gate for the tankering weight penalty - carrying fuel costs fuel, and without that
/// the optimal strategy would always be "fill up at the cheapest airport". Agreed with the user
/// 2026-08-08: a flight carrying no
